...
function modifier_ability_thdots_keine02_invincible:GetAbsoluteNoDamagePhysical() return 1 end
function modifier_ability_thdots_keine02_invincible:GetAbsoluteNoDamageMagical() return 1 end
function modifier_ability_thdots_keine02_invincible:GetAbsoluteNoDamagePure() return 1 end
